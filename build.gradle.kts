    ...
    publications {
        ...
        withType<MavenPublication> {
            ...
            pom {
                ...
                url.set("https://github.com/weavechain/threshold-encrypt")
                licenses {
                    license {
                        name.set("MIT")
                ...
                issueManagement {
                    system.set("Github")
                    url.set("https://github.com/weavechain/threshold-encrypt/issues")
                }
                scm {
                    connection.set("scm:git:git://github.com/weavechain/threshold-encrypt.git")
                    developerConnection.set("scm:git:git@github.com:weavechain/threshold-encrypt.git")
                    url.set("https://github.com/weavechain/threshold-encrypt")
                }
                developers {
                    developer {
...
tasks {
    ...
    val releaseJar by creating(Jar::class) {
        archiveClassifier.set("threshold-encrypt")
